...
import { ExternalLink, Eye, MessageSquare, ThumbsUp, Trash2, UserPlus, Briefcase, CheckCircle } from "lucide-react";
...
const NotificationsPage = () => {
			...
			case "applicationStatus":
				return (
					<span>
						...
						updated the status of your job application
					</span>
				);
			default:
				return null;
	...
	const renderRelatedItem = (notification) => {
		if (notification.relatedPost) {
			...
			return (
				<Link
					to={`/jobs/${notification.relatedJob}`}
					className='mt-2 p-2 bg-gray-50 rounded-md flex items-center space-x-2 hover:bg-gray-100 transition-colors'
				>
					<Briefcase className='text-primary w-10 h-10 p-2' />
									...
									<div className='flex items-start justify-between'>
										<div className='flex items-center space-x-4'>
											...
											<div>
												...
												{renderRelatedItem(notification)}
											</div>
										</div>
